    ...
    <div>
      ...
      <body>
        <main>
          ...
          <p style={{ fontSize: '21px', position: 'absolute', left: '80px', top: '160px' }}>
          ...
          <p style={{ fontSize: '20px', position: 'absolute', left: '570px', top: '230px' }}>Collaboration is the key of my growth, refining communication, cooperation, and attitude towards challenges. Diligence, reliability, and dedication to self-improvement characterize my approach.<br />
          ...
          <Link to="/portfolio">
            <div className="BigEllipse">
              <p style={{ color: 'black', textAlign:'center', fontSize:'23px' }}>VIEW MY PORTFOLIO</p>
            </div>
          </Link>
          <Routes>
